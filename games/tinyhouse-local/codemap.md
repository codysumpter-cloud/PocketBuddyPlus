...
- `house-grid.js` — shared structure runtime, persistence boundary, and public `TinyHouseStructure` API.
...
- `drag-core.js` — pointer-offset and complete placement snapshot helpers.
...
- `wall-mount.js` — wall-item placement UI, badges, metadata, and restoration.
...
- `test-wall-contract.mjs` — tabletop depth and wall-mount behavior.
- `test-house-grid-contract.mjs` — cell/edge topology, expansion, door connectivity, exact projection, persistence, and full-house export contract.
