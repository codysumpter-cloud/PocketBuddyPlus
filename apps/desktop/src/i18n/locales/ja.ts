...
export const ja: Partial<Messages> = {
  ...
  "integrations.pi.description": "コンパニオン Pi 拡張パッケージを通じて Pi コーディングエージェントの活動を接続します。",
  ...
  "integrations.pi.intro": "Pi からコンパニオン Pi 拡張機能をインストールし、Pi セッション内でスラッシュコマンドを使用します。",
  ...
  "integrations.pi.outro": "すべての Pi ワークスペースに使うにはグローバルインストール、現在のプロジェクトだけでコンパニオン拡張機能を使うにはプロジェクトインストールを選びます。",
