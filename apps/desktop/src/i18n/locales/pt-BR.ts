...
export const ptBR: Partial<Messages> = {
  ...
  "integrations.pi.description": "Conecte a atividade do agente de programação Pi através do pacote de extensão Pi complementar.",
  ...
  "integrations.pi.intro": "Instale a extensão Pi complementar a partir do Pi e use os comandos de barra dentro de uma sessão do Pi.",
  ...
  "integrations.pi.outro": "Use a instalação global para todos os workspaces do Pi, ou a instalação no projeto quando quiser a extensão complementar apenas no projeto atual.",
