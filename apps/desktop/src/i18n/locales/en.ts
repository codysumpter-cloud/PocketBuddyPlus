...
export const en = {
  ...
  "settings.reactions.petSelector": "Buddy",
  "settings.reactions.petSelectorDescription": "Mappings are saved separately for each installed Buddy.",
  "settings.reactions.editingPet": "Editing {name} · {count} selectable animations",
  ...
  "plugins.card.toggleLabel": "Enable or disable {name}",
  ...
  "integrations.pi.description": "Connect Pi coding-agent activity through the companion Pi extension package.",
  ...
  "integrations.pi.intro": "Install the companion Pi extension from Pi, then use the slash commands inside a Pi session.",
  ...
  "integrations.pi.outro": "Use global install for all Pi workspaces, or project install when you only want the companion extension in the current project.",
