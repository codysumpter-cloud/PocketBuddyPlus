...
export const zhHant: Partial<Messages> = {
  ...
  "integrations.pi.description": "透過配套 Pi 擴充套件連接 Pi 程式設計代理的活動。",
  ...
  "integrations.pi.intro": "從 Pi 安裝配套 Pi 擴充套件，然後在 Pi 工作階段中使用斜線指令。",
  ...
  "integrations.pi.outro": "所有 Pi 工作區皆使用全域安裝；只想在目前專案使用配套擴充套件時則選擇專案安裝。",
