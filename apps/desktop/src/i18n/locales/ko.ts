...
export const ko: Partial<Messages> = {
  ...
  "integrations.pi.description": "컴패니언 Pi 확장 패키지를 통해 Pi 코딩 에이전트 활동을 연결하세요.",
  ...
  "integrations.pi.intro": "Pi에서 컴패니언 Pi 확장을 설치한 다음 Pi 세션 안에서 슬래시 명령을 사용하세요.",
  ...
  "integrations.pi.outro": "모든 Pi 워크스페이스에는 전역 설치를, 현재 프로젝트에서만 컴패니언 확장을 사용하려면 프로젝트 설치를 사용하세요.",
