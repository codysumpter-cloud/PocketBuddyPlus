...
export const zhHans: Partial<Messages> = {
  ...
  "plugins.card.toggleLabel": "启用或禁用 {name}",
  ...
  "integrations.pi.description": "通过配套 Pi 扩展包连接 Pi 编程代理活动。",
  ...
  "integrations.pi.intro": "从 Pi 安装配套 Pi 扩展，然后在 Pi 会话中使用斜杠命令。",
  ...
  "integrations.pi.outro": "全局安装适用于所有 Pi 工作区，项目安装则仅在当前项目中启用配套扩展。",
