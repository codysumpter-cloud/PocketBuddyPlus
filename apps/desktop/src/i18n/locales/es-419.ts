...
export const es419: Partial<Messages> = {
  ...
  "integrations.pi.description": "Conecta la actividad del agente de programación Pi mediante el paquete de extensión Pi complementario.",
  ...
  "integrations.pi.intro": "Instala la extensión Pi complementaria desde Pi y luego usa los comandos de barra dentro de una sesión de Pi.",
  ...
  "integrations.pi.outro": "Usa la instalación global para todos los espacios de trabajo de Pi, o la instalación del proyecto cuando solo quieras la extensión complementaria en el proyecto actual.",
