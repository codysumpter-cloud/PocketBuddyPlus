...
const api = {
  ...
  getMonitorSelection: () => ipcRenderer.invoke("openpets:get-monitor-selection"),
  setMonitorSelection: (selection) => ipcRenderer.invoke("openpets:set-monitor-selection", selection),
  ...
  getReactionAnimationSettings: (petId) => ipcRenderer.invoke("openpets:get-reaction-animation-settings", petId),
  setReactionAnimationOverrides: (petId, overrides) => ipcRenderer.invoke("openpets:set-reaction-animation-overrides", petId, overrides),
  ...
  initializeBuddyProfile: (candidate) => ipcRenderer.invoke("openpets:buddy-profile-initialize", candidate),
  getBuddyProfile: () => ipcRenderer.invoke("openpets:buddy-profile-get"),
  syncBuddyProfile: (candidate) => ipcRenderer.invoke("openpets:buddy-profile-sync", candidate),
