...
import { BuddyDriveSet, DEFAULT_DRIFT_PER_SECOND, DEFAULT_PRESSURES, DRIVE_KEYS, } from "../src/drive-set.js";
...
test("default drift rates are the donor values, and safety alone is negative", () => {
    ...
    for (const key of DRIVE_KEYS)
        assert.equal(DEFAULT_DRIFT_PER_SECOND[key], expected[key], key);
